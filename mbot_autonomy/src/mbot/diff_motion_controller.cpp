...
private:
    // float pid[2] = {1.0, 2.5}; //kx, kw
    float pid[2] = {1.0, 2.0}; //kx, kw
    // float pid[3] = {1.0, 3.5, 0.0};
    float d_end_crit = 0.02;
    float d_end_midsteps = 0.08;
    float angle_end_crit = 0.2;
public:
    ...
    virtual mbot_lcm_msgs::twist2D_t get_command(const mbot_lcm_msgs::pose2D_t& pose, const mbot_lcm_msgs::pose2D_t& target) override
    {
        ...
        // float fwd_vel = vel_sign *  pid[0] * d_fwd;
        // float turn_vel = pid[1] * alpha + pid[2] * beta;
        float fwd_vel = vel_sign *  pid[0] * L;
        float turn_vel = pid[1] / r;
...
public: 
    ...
    */
        ...
        odomToGlobalFrame_{0, 0, 0, 0}
    {
        ...
        // Default velocity limits (vx = 0.3, vy = 0, wz = 2*pi/3)
        // vel_limits_.vx = 0.3; 
        vel_limits_.vx = 0.3; 
        vel_limits_.vy = 0;
        vel_limits_.wz = M_PI * 2.0 / 3.0;

        // // Slow velocity limits 
        // vel_limits_.vx = 0.2; 
        // vel_limits_.vy = 0;
        // vel_limits_.wz = M_PI / 4.0;

        // // High velocity limits 
        // vel_limits_.vx = 0.8; 
        // vel_limits_.vy = 0;
        // vel_limits_.wz = M_PI;
    }
