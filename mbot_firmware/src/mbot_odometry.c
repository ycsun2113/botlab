...
int mbot_calculate_odometry(serial_twist2D_t mbot_vel, float dt, serial_pose2D_t *odometry, serial_mbot_imu_t *mbot_imu){
    ...
    odometry->theta = mbot_imu->angles_rpy[2];
